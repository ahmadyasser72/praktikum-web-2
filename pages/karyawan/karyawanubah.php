      ...
      <form action="" method="POST">
        ...
        <div class="mb-3 mt-3">
          ...
          <input type="text" class="form-control" id="nama" name="nama"
            placeholder="misal: Fulan" value="<?php echo $row[
                "nama"
            ]; ?>" required>
        </div>
        <div class="mb-3 mt-3">
          ...
          <input type="date" class="form-control" id="tanggal_mulai"
            name="tanggal_mulai" value="<?php echo $row[
                "tanggal_mulai"
            ]; ?>" required>
        </div>
        <div class="mb-3 mt-3">
          ...
          <input type="number" class="form-control" id="gaji_pokok"
            name="gaji_pokok" value="<?php echo $row[
                "gaji_pokok"
            ]; ?>" required>
        </div>
        ...
        <div class="mb-3 mt-3">
          ...
          <select class="form-select" name="bagian_id">
            ...
            <?php while ($row_bagian = mysqli_fetch_assoc($resultSelect)) {
                $bagian_selected =
                    $row["bagian_id"] == $row_bagian["id"] ? "selected" : ""; ?>
              <option value="<?php echo $row_bagian[
                  "id"
              ]; ?>" <?php echo $bagian_selected; ?> > <?php echo $row_bagian[
     "nama"
 ]; ?> </option> <?php
            } ?>
          </select>
